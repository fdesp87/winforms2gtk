...
package Emit_Controls is
   ...
   procedure Emit_GtkEntry (TWdg : Widget_Pointer;
                            Id   : Integer);
   procedure Emit_GtkSpinButton (TWdg : Widget_Pointer;
                                 Id   : Integer);
   procedure Emit_GtkToggleButton (TWdg      : Widget_Pointer;
                                   ...
                                   XY        : Boolean;
                                  Homog     : Boolean);
   procedure Emit_GtkCheckButton (TWdg : Widget_Pointer;
                                  Id : Integer);
   ...
   procedure Emit_GtkComboTextBox (TWdg    : Widget_Pointer;
                                   Id      : Integer;
                                   Packing : Boolean);
   procedure Emit_GtkFileChooserButton (TWdg : Widget_Pointer;
                                        Id   : Integer);
   procedure Emit_GtkColorButton (TWdg : Widget_Pointer;
                                  Id   : Integer);
