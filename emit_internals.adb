...
package body Emit_Internals is
   ...
   procedure Emit_Internal_Child_VBox (TWdg : Widget_Pointer;
                                       Id   : Integer) is
   ...
   procedure Emit_Internal_Child_Action_Area (TWdg : Widget_Pointer;
                                              Id   : Integer) is
      Child : Widget_Pointer := TWdg.Child_List;
   begin
      Emit_Line (Sp (Id) & "<child internal-child=""action_area"">");
      Debug (-1, Sp (Id) & "internal-child=""action_area""");
   ...
   procedure Emit_Action_Widgets (TWin : Window_Pointer;
                                  Id   : Integer) is
      TWdg : Widget_Pointer;
   begin
